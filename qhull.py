...
class ConvexHull:
    ...
    def Plot(self):
        ...
        plt.plot(ans_x, ans_y, 'g-',markersize=10)
...
if __name__ == "__main__":
    ...
    # points=[(np.rand(),np.rand()) for i in range(10)]
    # points = [(5,0),(-5,0),(-4,3),(2,4),(-1,1),(4,3),(-2,-3),(2,-2),(4,-5),(1,1),(5,5),(7,8),(9,8),(8,10)]
